...
//         className={[
//           containerClassName,
//           "justify-end pr-[18px]", // ✅ align RHS with padding
//         ].join(" ")}
//         style={style}
...
//         >
//           <div
//             className="menu-window relative flex flex-col items-center justify-center p-8"
//             style={{
//               width: "60%",
//               height: "60%",
...
//               overflow: "hidden",
//               pointerEvents: "auto", // make window clickable
//             }}
//           >
//             <ul
//               className={[
//                 "pill-list",
//                 "list-none m-0 px-6",
//                 "w-full h-full flex flex-wrap gap-x-0 gap-y-1",
//               ].join(" ")}
//               role="menu"
